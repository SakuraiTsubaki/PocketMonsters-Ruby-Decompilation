...
| [Toolchain and Emulator](TOOLCHAIN.md) | GBA/ARM toolchain, pinned agbcc, mGBA, setup, and environment checks |
...
2. Prepare and verify the GBA development environment according to `TOOLCHAIN.md`.
