...
This document is the authoritative coverage ledger for public-source research used by the Pocket Monsters Ruby decompilation project.
...
| Official event/distribution preservation | Eon Ticket and all Gen III distributions linked to Ruby; metadata and provenance | In progress |
...
| GameCube linkage | Colosseum, XD, Box, Channel and Bonus Disc interactions relevant to Ruby | Not yet exhaustive |
...
| OFF-JP-NIN-RS | https://www.nintendo.co.jp/n08/axvp/ | Official | Nintendo Japan historical Ruby/Sapphire page; release details and Berry-related notice entry point | Observed |
| SRC-PRET-RS | https://github.com/pret/pokeruby | Source reconstruction | Major public Ruby/Sapphire decompilation/disassembly baseline; English/German-supported source and history | Observed |
| SRC-PRET-BERRY | https://github.com/pret/berry-fix | Source reconstruction | Decompilation of the Berry Fix multiboot program embedded in later Gen III titles | Observed |
| PRES-GEKKIO-AXVJ | https://gbhwdb.gekkio.fi/cartridges/AGB-AXVJ-0/ | Preservation / physical | Japanese Ruby revision variants, cartridge labels, PCB/components, links to No-Intro identity | Observed |
| REF-BULBA-RS | https://bulbapedia.bulbagarden.net/wiki/Pok%C3%A9mon_Ruby_%26_Sapphire_Versions | Community reference | Localization, version-history, e-Reader and linkage leads; must be independently checked | Observed |
