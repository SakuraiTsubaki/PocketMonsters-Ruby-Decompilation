...
A complete, target-specific workspace for reproducible research, analysis, tooling, source reconstruction, and retained non-ROM work products related to **Pocket Monsters Ruby**.

| Field | Value |
| --- | --- |
| Working target | Pocket Monsters Ruby |
| Platform family | Game Boy Advance |
| Series generation | Generation III |
| Exact build identity | Japanese retail `AXVJ` revision 0; identified, verification pending |
